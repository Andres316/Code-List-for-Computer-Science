...
# question 3
print("Question 3: When did Superman die\n")
...
# question 4
print("Question 4: Which franchise did not crossover with Marvel\n")

print('a.Ninja Turtles')
print("b.Transformers")
print("c.Godzilla")

Q4answer="a" # the right answer to question 4
Q4response= input("Your answer: ")

if Q4response == "A" or Q4answer== 'a':
